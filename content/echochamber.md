+++
title = "BST Echo Chamber"
date = 2025-03-11
+++

Le BST Echo Chamber est comme son nom l'indique une chambre à écho, purement analogique qui fonctionne avec des bandes.
...
De base, le délai est assez court. Utilisé surtout pour l'effet slapback sur une guitare.
De mon côté je trouve que le délai est trop court. J'ai lu sur un forum qu'on pouvait remplacer le potentiomètre de contrôle de vitesse du moteur pour avoir un délai plus long.

Il s'agit du potentiomètre tout à droite. Sa valeur est de 5kΩ. Il est possible de la remplacer par un potard de 500kΩ.
Mon potentiomètre était beaucoup plus petit, du coup la goupille de calage de rentrait pas dans l'embout prévue directement dans le panneau en métal. J'ai simplement retiré la goupille et hop, tout rentre très bien. Ca prend 5min à faire et je vous le conseille vraiment.
